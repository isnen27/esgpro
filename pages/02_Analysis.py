...
from nltk.tokenize import word_tokenize # Hanya word_tokenize, sent_tokenize akan kita tangani sendiri
...
import heapq
import os
import pickle # Impor pickle untuk memuat tokenizer
...
def download_nltk_data_for_analysis():
    ...
    # Ini mengatasi masalah 'punkt_tab' dengan memuat file pickle secara langsung
    try:
...
if st.session_state.crawled_data and st.session_state.final_esg_category:
    ...
    crawled_date = st.session_session_state.crawled_data['crawled_date']
